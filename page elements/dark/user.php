    ...
    <div class="user_profile">
        <div class="user_images">
            <div class="cover_image">
                <img src="../../assets/user_page_images/user_page_dark.jpg" alt="change the default cover image">
            </div>
        ...
        <div class="user_details">
            ...
            <?php 
                if($row['description']==NULL){
                    echo "
                        <form action='../../scripts/user_scripts/update_user_description.php?m=d' method='post' class='input_user_desc'>
