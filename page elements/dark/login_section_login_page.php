...
<div class="login_box">
    <div class="text_box">
        <form action="../../scripts/user_login_and_signup_scripts/test_login_input.php?m=d" method="post">
            <h3>Login:</h3>
            <h6>username:</h6>
            ...
            <a href="../../pages/dark/signup.php">don't have accout yet Sign-Up now.</a>
        </form>
    </div>
    <div class="img_box"><!--
