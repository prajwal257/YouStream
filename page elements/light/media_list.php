        ...
        <div class="list_of_media">
            ...
            <div class="list">     
                <?php
                    ...
                    $sql = 'SELECT * FROM `videos` ORDER BY `videoid` DESC';
                                    ...
                                    <div class="model_main_container">
                                        ...
                                        <div class="model_main">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="controls">
                                                    <a href="../../pages/light/movie_player.php?v_tag=' . $row['tag']. '&v_id=' . $row['videoid'] . '" class="button">Play</a>
                                                    <a href="../../pages/light/movie_player.php?v_tag=' . $row['tag']. '&v_id=' . $row['videoid'] . '"  class="button secondary">Watch Later</a>
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
